...
//   // POST /api/execution-circle/create
...
//   // POST /api/execution-circle/join/:circleId
...
//   // GET /api/execution-circle/:circleId
...
//   // POST /api/execution-circle/post
...
//   // POST /api/execution-circle/comment
...
//   // POST /api/execution-circle/like
...
//     try {
//       console.log('LEADERBOARD PARAMS:', req.params);
//       getAuthUser(req);
//       const { circleId } = UUIDParamSchema.parse(req.params);
...
//   // GET /api/execution-circle/:circleId/insights
...
//       getAuthUser(req);
//       const { circleId } = UUIDParamSchema.parse(req.params);
//       const health = await this.service.getCircleHealth(circleId);
...
//   // POST /api/execution-circle/proof
...
//         return;
//       }
//       const result = await this.service.uploadProof(userId, circle_id, image_url, description || '');
...
//   // POST /api/execution-circle/change-request
