...
//   async getCircleInsights(circleId: string) {
...
//     const avgScore =
//       members.reduce(
//         (s, m) => s + (m.accountability_score || 0),
//         0
//       ) / members.length;

//     const avgStreak =
//       members.reduce(
//         (s, m) => s + (m.streak_days || 0),
//         0
//       ) / members.length;

//     const avgCompletion =
//       members.reduce(
//         (s, m) => s + (m.weekly_completion || 0),
//         0
//       ) / members.length;

//     return {
//       avg_score: Math.round(avgScore),
//       better_than: Math.round(avgScore * 0.8),
